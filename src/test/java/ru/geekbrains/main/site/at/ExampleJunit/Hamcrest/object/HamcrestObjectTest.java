package ru.geekbrains.main.site.at.ExampleJunit.Hamcrest.object;
...
public class HamcrestObjectTest {
    ...
    // В нашем случае экземпляр класса Dog.
    // Проверим, что его метод toString() возвращает заданное значение:
    @Test
